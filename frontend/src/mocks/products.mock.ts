...
function mk(seed: Seed): Product {
  ...
  return {
    ...
    moq: seed.moq,
    buyerSegments: seed.buyerSegments,
  };
}
...
const seeds: Seed[] = [
  ...
  // ---- HOME DECOR (4)
  { categoryId: categoryIds.festiveCollection, name: 'Hand-Embroidered Table Runner', slug: 'hand-embroidered-table-runner', sku: 'BT-TL-001', shortDescription: 'Linen table runner, gold thread embroidery.', description: 'Pure linen table runner with hand-embroidered gold thread work.', price: 2299, stock: 60, newArrival: true, ratingAvg: 4.6, ratingCount: 11, variants: [{ size: '72in', color: 'Ivory', stock: 30 }, { size: '108in', color: 'Ivory', stock: 30, priceDelta: 700 }] },
  { categoryId: categoryIds.summerCollection, name: 'Block-Printed Cotton Tablecloth', slug: 'block-printed-cotton-tablecloth', sku: 'BT-TL-002', shortDescription: 'Hand-block-printed cotton tablecloth.', description: 'Hand-block-printed cotton tablecloth, fits 6-seater dining tables.', price: 1899, salePrice: 1399, stock: 80, ratingAvg: 4.4, ratingCount: 38, variants: [{ size: '6-seater', color: 'Indigo', stock: 40 }, { size: '8-seater', color: 'Indigo', stock: 40, priceDelta: 500 }] },
  { categoryId: categoryIds.festiveCollection, name: 'Handwoven Wall Tapestry', slug: 'handwoven-wall-tapestry', sku: 'BT-WD-001', shortDescription: 'Handwoven wool wall tapestry.', description: 'Hand-woven wool wall tapestry with traditional tribal motifs.', price: 5999, salePrice: 4499, stock: 18, featured: true, ratingAvg: 4.7, ratingCount: 8, variants: [{ size: '3x4', color: 'Earth', stock: 9 }, { size: '4x6', color: 'Earth', stock: 9, priceDelta: 1800 }] },
  { categoryId: categoryIds.festiveCollection, name: 'Festive Toran Door Hanging', slug: 'festive-toran-door-hanging', sku: 'BT-FD-001', shortDescription: 'Handcrafted festive toran with bells.', description: 'Handcrafted festive toran with brass bells and mirror work.', price: 1299, stock: 120, newArrival: true, ratingAvg: 4.5, ratingCount: 47, variants: [{ size: '36in', color: 'Multicolour', stock: 120 }] },
...
const catalogueSeeds: Seed[] = [
  { categoryId: categoryIds.printedBedsheets, name: 'Jaipuri Bagru Print Double Bedsheet', slug: 'jaipuri-bagru-print-double-bedsheet', sku: 'BT-BS-101', shortDescription: 'Reactive-printed cotton bedsheet with a signature Bagru motif.', description: 'A production-ready printed double bedsheet designed for hospitality, gifting and export retail programs.', price: 1099, stock: 5000, bestSeller: true, specification: '144 TC reactive print', sizeLabel: '90x100 in', moq: '500 pcs', buyerSegments: ['Hospitality', 'Export retail', 'Gifting'], variants: [{ size: 'Double', color: 'Indigo', stock: 2500 }, { size: 'Double', color: 'Saffron', stock: 2500 }] },
  { categoryId: categoryIds.printedBedsheets, name: 'Floral Reactive Double Bedsheet', slug: 'floral-reactive-double-bedsheet', sku: 'BT-BS-108', shortDescription: 'Colour-fast floral reactive print for repeat hospitality orders.', description: 'Soft poly-cotton construction with a vivid floral reactive print and dependable wash performance.', price: 1299, stock: 3000, newArrival: true, specification: '180 TC reactive print', sizeLabel: '100x108 in', moq: '300 pcs', buyerSegments: ['Hospitality', 'Export retail', 'Gifting'], variants: [{ size: 'Double', color: 'Rose', stock: 3000 }] },
  { categoryId: categoryIds.printedBedsheets, name: 'Solid Sateen Double Bedsheet', slug: 'solid-sateen-double-bedsheet', sku: 'BT-BS-115', shortDescription: 'Clean sateen finish for hotel and private-label programs.', description: 'A smooth, understated sateen range made for consistent bulk production and private labelling.', price: 1499, stock: 3000, specification: '210 TC sateen', sizeLabel: '108x108 in', moq: '300 pcs', buyerSegments: ['Hospitality', 'Private label'], variants: [{ size: 'Double', color: 'Ivory', stock: 3000 }] },
  { categoryId: categoryIds.printedBedsheets, name: 'Kids Cartoon Double Bedsheet', slug: 'kids-cartoon-double-bedsheet', sku: 'BT-BS-122', shortDescription: 'Playful printed range for children’s retail and gifting.', description: 'Bright, durable cotton-blend sheets with kid-friendly cartoon artwork.', price: 999, stock: 5000, specification: '144 TC printed', sizeLabel: '60x90 in', moq: '500 pcs', buyerSegments: ['Retail', 'Gifting'], variants: [{ size: 'Single', color: 'Multicolour', stock: 5000 }] },
  { categoryId: categoryIds.printedBedsheets, name: 'Hotel White Double Bedsheet', slug: 'hotel-white-double-bedsheet', sku: 'BT-BS-130', shortDescription: 'Reliable white linen for hospitality replenishment.', description: 'A crisp, easy-care white sheet with dependable sizing for hotel rooms and institutional use.', price: 1199, stock: 2000, specification: '200 TC plain weave', sizeLabel: '108x108 in', moq: '200 pcs', buyerSegments: ['Hospitality', 'Government tenders'], variants: [{ size: 'Double', color: 'Ivory', stock: 2000 }] },
  { categoryId: categoryIds.winterBlankets, name: 'Embossed Single Mink Blanket', slug: 'embossed-single-mink-blanket', sku: 'BT-MB-201', shortDescription: 'Double-ply embossed mink blanket for winter retail.', description: 'Soft, warm and retail-ready with polybag or gift-box packing options.', price: 1599, stock: 3000, bestSeller: true, specification: '1.6 kg double-ply mink', sizeLabel: '60x90 in', moq: '300 pcs', buyerSegments: ['Winter retail', 'Gifting'], variants: [{ size: 'Single', color: 'Sage', stock: 3000 }] },
  { categoryId: categoryIds.winterBlankets, name: 'Printed Double Mink Blanket', slug: 'printed-double-mink-blanket', sku: 'BT-MB-204', shortDescription: 'Printed Korean-mink style blanket with a soft hand feel.', description: 'A warm double-size blanket for seasonal retail, corporate gifting and tenders.', price: 2299, stock: 3000, specification: '2.0 kg double-ply mink', sizeLabel: '90x100 in', moq: '300 pcs', buyerSegments: ['Winter retail', 'Corporate gifting'], variants: [{ size: 'Double', color: 'Burgundy', stock: 3000 }] },
  { categoryId: categoryIds.winterBlankets, name: 'Korean Mink Heavy Blanket', slug: 'korean-mink-heavy-blanket', sku: 'BT-MB-210', shortDescription: 'Heavyweight blanket for cold-weather retail and gifting.', description: 'Premium Korean-mink construction with an embossed or solid finish.', price: 2699, stock: 2000, specification: '2.2 kg Korean mink', sizeLabel: '90x100 in', moq: '200 pcs', buyerSegments: ['Winter retail', 'Government tenders'], variants: [{ size: 'Double', color: 'Charcoal', stock: 2000 }] },
  { categoryId: categoryIds.winterBlankets, name: 'Baby Mink Blanket', slug: 'baby-mink-blanket', sku: 'BT-MB-215', shortDescription: 'Lightweight baby mink blanket for gifting programs.', description: 'A compact, soft and easy-to-pack blanket for baby and gifting ranges.', price: 899, stock: 5000, newArrival: true, specification: '0.8 kg soft mink', sizeLabel: '36x54 in', moq: '500 pcs', buyerSegments: ['Gifting', 'Retail'], variants: [{ size: 'Baby', color: 'Sky', stock: 5000 }] },
  { categoryId: categoryIds.cottonMats, name: 'Cotton Dhurrie Stripe', slug: 'cotton-dhurrie-stripe', sku: 'BT-FM-301', shortDescription: 'Yarn-dyed stripe dhurrie woven on a pit loom.', description: 'A durable handloom cotton dhurrie with optional vegetable-dye finishing.', price: 699, stock: 3000, specification: 'Handloom cotton weave', sizeLabel: '2x3 ft', moq: '300 pcs', buyerSegments: ['Home decor', 'Boutique retail'], variants: [{ size: '2x3 ft', color: 'Mustard', stock: 3000 }] },
  { categoryId: categoryIds.cottonMats, name: 'Block-Print Floor Runner', slug: 'block-print-floor-runner', sku: 'BT-FM-305', shortDescription: 'Block-printed cotton runner for lifestyle retail.', description: 'A hand-finished runner with an artisan print and durable everyday construction.', price: 999, stock: 2000, specification: 'Block-print cotton', sizeLabel: '2x5 ft', moq: '200 pcs', buyerSegments: ['Boutique retail', 'Export lifestyle'], variants: [{ size: '2x5 ft', color: 'Indigo', stock: 2000 }] },
  { categoryId: categoryIds.areaRugs, name: 'Living Room Cotton Rug', slug: 'living-room-cotton-rug', sku: 'BT-FM-312', shortDescription: 'Statement cotton rug for living spaces and export lifestyle.', description: 'A broader handloom floor piece designed for living-room collections.', price: 2499, stock: 1000, bestSeller: true, specification: 'Handloom cotton weave', sizeLabel: '5x8 ft', moq: '100 pcs', buyerSegments: ['Home decor', 'Export lifestyle'], variants: [{ size: '5x8 ft', color: 'Earth', stock: 1000 }] },
  { categoryId: categoryIds.cottonMats, name: 'Yoga Mat Weave', slug: 'yoga-mat-weave', sku: 'BT-FM-320', shortDescription: 'Textured cotton weave for yoga and wellness programs.', description: 'A breathable, durable woven mat with a natural handloom character.', price: 549, stock: 5000, specification: 'Cotton pit-loom weave', sizeLabel: '24x68 in', moq: '500 pcs', buyerSegments: ['Wellness', 'Retail'], variants: [{ size: '24x68 in', color: 'Natural', stock: 5000 }] },
  { categoryId: categoryIds.quilts, name: 'Summer AC Comforter', slug: 'summer-ac-comforter', sku: 'BT-CM-401', shortDescription: 'Lightweight microfibre comforter for warm climates.', description: 'A soft, easy-care comforter with a custom shell print option.', price: 1799, stock: 2000, specification: '150 GSM microfibre fill', sizeLabel: '90x100 in', moq: '200 pcs', buyerSegments: ['Hospitality', 'E-commerce private label'], variants: [{ size: 'Double', color: 'Ivory', stock: 2000 }] },
  { categoryId: categoryIds.quilts, name: 'Winter Razai Quilt', slug: 'winter-razai-quilt', sku: 'BT-CM-408', shortDescription: 'Hand-stitched razai with a warm winter fill.', description: 'A versatile quilt for winter hospitality, retail and private-label programs.', price: 2299, stock: 2000, specification: '300 GSM filled quilt', sizeLabel: '90x100 in', moq: '200 pcs', buyerSegments: ['Hospitality', 'Private label'], variants: [{ size: 'Double', color: 'Saffron', stock: 2000 }] },
  { categoryId: categoryIds.quilts, name: 'Hotel White Duvet', slug: 'hotel-white-duvet', sku: 'BT-CM-415', shortDescription: 'Clean white duvet for hotel room programmes.', description: 'A dependable white duvet with consistent construction for hospitality orders.', price: 1999, stock: 1500, specification: '220 GSM microfibre fill', sizeLabel: '90x100 in', moq: '150 pcs', buyerSegments: ['Hospitality'], variants: [{ size: 'Double', color: 'Ivory', stock: 1500 }] },
  { categoryId: categoryIds.cushionCovers, name: 'Standard Pillow Cover Pair', slug: 'standard-pillow-cover-pair', sku: 'BT-PC-501', shortDescription: 'Cotton pillow pair designed to match bedsheet programs.', description: 'A clean, dependable pillow-cover pair for matched hospitality and gifting sets.', price: 399, stock: 10000, bestSeller: true, specification: 'Cotton percale', sizeLabel: '17x27 in', moq: '1000 pcs', buyerSegments: ['Hospitality', 'Gifting'], variants: [{ size: 'Standard', color: 'Ivory', stock: 10000 }] },
  { categoryId: categoryIds.cushionCovers, name: 'Jacquard Cushion Cover', slug: 'jacquard-cushion-cover', sku: 'BT-PC-508', shortDescription: 'Decorative jacquard cover with a considered finish.', description: 'A premium cushion cover for home decor collections and gifting.', price: 499, stock: 5000, specification: 'Cotton jacquard', sizeLabel: '16x16 in', moq: '500 pcs', buyerSegments: ['Home decor', 'Gifting'], variants: [{ size: '16x16 in', color: 'Gold', stock: 5000 }] },
  { categoryId: categoryIds.cushionCovers, name: 'Bolster Cover', slug: 'bolster-cover', sku: 'BT-PC-514', shortDescription: 'Piped bolster cover for coordinated bedding sets.', description: 'A long-format cushion cover that completes matched bedroom programs.', price: 449, stock: 5000, specification: 'Cotton with piping', sizeLabel: '9x27 in', moq: '500 pcs', buyerSegments: ['Hospitality', 'Home decor'], variants: [{ size: '9x27 in', color: 'Rose', stock: 5000 }] },
  { categoryId: categoryIds.bathTowels, name: 'Bath Towel Economy', slug: 'bath-towel-economy', sku: 'BT-TW-601', shortDescription: 'Combed-cotton towel for dependable daily hospitality use.', description: 'An economical towel with consistent absorbency for hotels, gifting and tenders.', price: 599, stock: 5000, specification: '380 GSM combed cotton', sizeLabel: '27x54 in', moq: '500 pcs', buyerSegments: ['Hospitality', 'Government tenders'], variants: [{ size: 'Bath towel', color: 'White', stock: 5000 }] },
  { categoryId: categoryIds.bathTowels, name: 'Bath Sheet Premium', slug: 'bath-sheet-premium', sku: 'BT-TW-608', shortDescription: 'Luxury spa-grade bath sheet with a fuller hand feel.', description: 'A premium bath sheet for hospitality, spa and gifting collections.', price: 1199, stock: 3000, featured: true, specification: '550 GSM combed cotton', sizeLabel: '30x60 in', moq: '300 pcs', buyerSegments: ['Spa & wellness', 'Gifting'], variants: [{ size: 'Bath sheet', color: 'Pearl', stock: 3000 }] },
  { categoryId: categoryIds.bathTowels, name: 'Hand Towel Set', slug: 'hand-towel-set', sku: 'BT-TW-612', shortDescription: 'Soft hand-towel set for matched bath-linen programs.', description: 'A practical set for hospitality, spa and corporate gifting orders.', price: 499, stock: 10000, specification: '450 GSM combed cotton', sizeLabel: '16x24 in', moq: '1000 pcs', buyerSegments: ['Hospitality', 'Gifting'], variants: [{ size: 'Set', color: 'White', stock: 10000 }] },
  { categoryId: categoryIds.luxuryCurtains, name: 'Blackout Curtain Panel', slug: 'blackout-curtain-panel', sku: 'BT-CT-701', shortDescription: 'Light-blocking panel for hospitality and interior projects.', description: 'A made-to-measure blackout panel suitable for hotel rooms and furnishing projects.', price: 1899, stock: 2000, bestSeller: true, specification: 'Triple-weave blackout', sizeLabel: '54x84 in', moq: '200 pcs', buyerSegments: ['Hospitality projects', 'Interior designers'], variants: [{ size: '54x84 in', color: 'Navy', stock: 2000 }] },
  { categoryId: categoryIds.luxuryCurtains, name: 'Sheer Curtain Panel', slug: 'sheer-curtain-panel', sku: 'BT-CT-706', shortDescription: 'Light-filtering sheer panel for layered interiors.', description: 'A soft, easy-to-layer sheer for hospitality and residential furnishing projects.', price: 1499, stock: 3000, specification: 'Lightweight sheer weave', sizeLabel: '54x84 in', moq: '300 pcs', buyerSegments: ['Hospitality projects', 'Interior designers'], variants: [{ size: '54x84 in', color: 'Ivory', stock: 3000 }] },
  { categoryId: categoryIds.luxuryCurtains, name: 'Printed Cotton Drape', slug: 'printed-cotton-drape', sku: 'BT-CT-710', shortDescription: 'Printed cotton furnishing panel with custom sizing.', description: 'A versatile cotton drape with made-to-measure options for hospitality and retail.', price: 1699, stock: 1500, newArrival: true, specification: 'Printed cotton furnishing fabric', sizeLabel: '54x96 in', moq: '150 pcs', buyerSegments: ['Hospitality projects', 'Interior designers'], variants: [{ size: '54x96 in', color: 'Indigo', stock: 1500 }] },
];

export const products: Product[] = [...seeds, ...catalogueSeeds].map(mk);
