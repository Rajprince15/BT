...
import { ArrowRight, Building2, Globe2, Handshake, HeartHandshake, Hotel, Package, PencilRuler, Sprout, Store, Truck, Users, Wrench } from 'lucide-react';
...
const audiences = [[Hotel, 'HOTELS', 'Premium linen for luxurious hospitality'], [Truck, 'RESORTS', 'Comfort meets elegance'], [Building2, 'HOSPITALS', 'Hygienic, durable and reliable'], [Hotel, 'HOSTELS', 'Quality textiles for everyday use'], [Store, 'RETAIL STORES', 'Wide range for retail businesses'], [PencilRuler, 'INTERIOR DESIGNERS', 'Custom collections for unique spaces'], [Package, 'CORPORATE GIFTING', 'Thoughtful gifting solutions']] as const;
...
export default function HomePageClient() {
  ...
  return <main data-testid="home-page" className="overflow-hidden bg-bg text-ink">
    <section data-testid="hero-section" className="relative min-h-[620px] overflow-hidden bg-bg">
      <Image src={images.hero} alt="Premium home textiles for bulk buyers" fill priority sizes="100vw" className="object-cover" />
